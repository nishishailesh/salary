...
{
	echo '<h4 align="center" style="border: 2px solid #000000;">Schedule of House Rent Deduction (Page:'.($n+1).')</h4>';
	...
	echo '<h4 align="center">Telephone: '.$GLOBALS['phone'].' [Bill: '.$_POST['bill_group'].'-'.$_POST['bill_number'].']</h4>';
	...
	echo '<table><tr><td align="right">Total in Words: '.Numbers_Words::toWords($a3['Rent_of_Building_9560(-)'],"en_US").' Only</td></tr>
				<tr><td  align="right">All above quarters are located at '.$GLOBALS['college'].'</td></tr>
	</table>';
