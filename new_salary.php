...
function edit_salary($link,$slr)
{
	...
	echo 	'<table class=border align=center style="horizontal-align:center;">
			<tr><th colspan=6>Government Medical college Surat,';
	...
	echo '</th></tr>';
	echo '<tr>';
	echo '<th>'.$slr['bank'].':'.$slr['bank_acc_number'].'</th><th>Bill:'.$slr['bill_number'].'</th><th>Head:';
	...
	</td><td>Net</td><td  style="text-align:right;" >'.($plus-$minus).'</td></tr>';
	echo '</table>';
	echo '</form>';
}
